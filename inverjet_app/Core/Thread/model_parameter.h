...
//-------------------------------------------------------------------------------------------------
//-------------- MOS 温度报警值 90°C -------------------
#define MOS_TEMP_ALARM_VALUE								(95)		//			85
//-------------- MOS 温度 降速 80°C -------------------
#define MOS_TEMP_REDUCE_SPEED								(90)		// 降档 温度			80
#define MOS_TEMP_RESTORE_SPEED							(85)		// 恢复 温度			75
//-------------------------------------------------------------------------------------------------
// 温度 降频  机箱
//*********************************************************************************************
//-------------------------------------------------------------------------------------------------
//-------------- 机箱温度报警值 90°C -------------------
#define AMBIENT_TEMP_ALARM_VALUE									(70)
//-------------- 机箱温度 降速 70°C -------------------
#define AMBIENT_TEMP_REDUCE_SPEED									(65)		// 降档 温度
#define AMBIENT_TEMP_RESTORE_SPEED								(60)		// 恢复 温度
//*********************************************************************************************
...
//*********************************************************************************************
//-------------- 电机功率 报警值  -------------------
#define SJ230_MOTOR_POWER_ALARM_VALUE								(1650)		//1450
//-------------- 电机功率 降速  -------------------
#define SJ230_MOTOR_POWER_REDUCE_SPEED							(1550)		// 降档		1350
#define SJ230_MOTOR_POWER_RESTORE_SPEED							(1450)		// 恢复		1250
//*********************************************************************************************

// 电流 降频
//*********************************************************************************************
//-------------- 输出电流 报警值  -------------------
#define SJ230_MOTOR_CURRENT_ALARM_VALUE								(90)		// 70
//-------------- 输出电流 降速  -------------------
#define SJ230_MOTOR_CURRENT_REDUCE_SPEED							(80)		// 降档	65
#define SJ230_MOTOR_CURRENT_RESTORE_SPEED							(75)		// 恢复	60
//*********************************************************************************************
#endif
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////
